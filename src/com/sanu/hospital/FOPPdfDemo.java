...
public class FOPPdfDemo {
    ...
    public static void convertToPDF()  throws IOException, FOPException, TransformerException {
        // the XSL FO file
        File xsltFile = new File("resources/values2fo.xsl");
        // the XML file which provides the input
        StreamSource xmlSource = new StreamSource(new File("resources/values.xml"));
        ...
        // Setup output
        OutputStream out;
        out = new java.io.FileOutputStream("./../patientDischargeForm.pdf");
