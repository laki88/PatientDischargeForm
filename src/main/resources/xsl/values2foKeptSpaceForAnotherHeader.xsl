    ...
    <xsl:template match="/formData">
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            <fo:layout-master-set>
                <fo:simple-page-master master-name="simple" page-height="29.7cm" page-width="21cm" margin-top="2.0cm" margin-bottom=".5cm" margin-left=".5cm" margin-right=".5cm">
                ...
                <fo:flow flow-name="xsl-region-body">
                    <fo:block break-after="page" font-size="8pt" linefeed-treatment="preserve">
                        <fo:table >
                            ...
                            <fo:table-body>
                                <fo:table-row>
                                    <fo:table-cell padding="6pt" text-align="left" margin-left="20mm">
